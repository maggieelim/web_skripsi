                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    {{-- EDIT --}}
                                    @if(in_array($thesis->status, ['draft', 'submitted', 'revision']))
                                    <a href="{{ route('thesis.edit', $thesis->id) }}"
                                    ...
                                    <form action="{{ route('thesis.destroy', $thesis->id) }}" method="POST"
                                        class="d-inline">

                                        @csrf
                                        @method('DELETE')

                                        <button class="btn bg-gradient-danger m-1 p-2 px-3"
                                            onclick="return confirm('Delete thesis?')">
